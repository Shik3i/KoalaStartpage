...
function initThemeSwitcher() {
  ...
  function applyTheme(themeName) {
    ...
    // Sync the PWA theme-color meta tag to match the active theme's background
    const themeColors = {
  ...
  // Support keydown navigation (Escape, ArrowDown, ArrowUp, Home, End)
